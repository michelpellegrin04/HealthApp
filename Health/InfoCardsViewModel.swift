...
class InfoCardsViewModel {
    ...
    var infoCards: [Card] = [
        ...
        Card(cardName: "The Basics of Fertility and Ovulation", cardDescription: "And their role in a menstrual cycle.", cardImage: "card2"),
        Card(cardName: "Learn about Spotting", cardDescription: "What you need to know about bleeding between periods.", cardImage: "card3"),
